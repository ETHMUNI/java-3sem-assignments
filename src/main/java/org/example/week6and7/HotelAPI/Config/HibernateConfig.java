package org.example.week6and7.HotelAPI.Config;
...
public class HibernateConfig {
    ...
    private static void getAnnotationConfiguration(Configuration configuration) {
        configuration.addAnnotatedClass(HotelDTO.class);
        configuration.addAnnotatedClass(RoomDTO.class);
    ...
    private static Properties setDevProperties(Properties props) {
        props.put("hibernate.connection.url", "jdbc:postgresql://localhost:7007/" + getDBName());
