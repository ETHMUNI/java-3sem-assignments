...
public class SignVerifyToken {
    ...
    public SignedJWT parseTokenAndVerify(String token) throws ParseException, JOSEException, AuthException {
    ...
    public UserDTO getJWTClaimsSet(JWTClaimsSet claimsSet) throws AuthException {

        if (new Date().after(claimsSet.getExpirationTime()))
            throw new AuthException(401, "Token is expired");
